L.OWM = L.TileLayer.extend({
	options: {
		appId: '4f15e9a093d5c0e59e9f98d6b7e8ec5a', /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
...
L.OWM.LegendControl = L.Control.extend({
	...
	_redrawLegend: function () {
		...
		var isLeft = this.options.position.indexOf('right') !== -1;
...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		...
		imageWidthPlane: 25,
		imageHeightPlane: 25,
		markerFunction: true, // user defined function for marker creation
...
L.OWM.CurrentCache = L.Class.extend({
	...
	clear: function () {
		...
		this._cachedTime = 0;
		this._cachedBBox = { minLon: 18, minLat: 1, maxLon: -18, maxLat: -91 };
	},
